...
void testAllExtins() {
	testCreeaza();//merge
	cout << "testCreeaza passed!\n";
	testAdauga();//merge
	cout << "testAdauga passed!\n";
	testSterge();//merge
	cout << "testSterge passed!\n";
	testIterator();//merge
